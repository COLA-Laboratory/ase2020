...
class bagging(AutoClassifier):
    def __init__(self, n_estimators, max_samples, max_features):
        self.nestimators = int(n_estimators)
    ...
    def fit(self, X, y, sample_weight):
        self.estimator = sklearn.ensemble.BaggingClassifier(n_estimators=self.nestimators, max_features=self.max_features,
    ...
    def get_hyperparameter_search_space(dataset_properties=None):
        ...
        n = UniformIntegerHyperparameter('n_estimators', 10, 200 ,100)
        maxfeature = UniformFloatHyperparameter('max_features', 0.7, 1.0, 1.0)
        maxsample = UniformFloatHyperparameter('max_samples', 0.7, 1.0, 1.0)
        cs.add_hyperparameters([n, maxfeature, maxsample])
        return cs
